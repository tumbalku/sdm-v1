...
public class CutiPdfService {
  ...
  public void makeAnCutiReport(Cuti cuti) throws FileNotFoundException, MalformedURLException {
    ...
    String rankGroup = getValue(user.getPangkat()) + "/ " + getValue(user.getGolongan());
